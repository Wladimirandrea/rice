...
.cal-header { display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px; padding: 0 8px; }
.cal-month  { font-size: 3rem; font-weight: 900; color: #fff; text-transform: uppercase; letter-spacing: 0.08em; margin: 0; text-shadow: 0 2px 12px rgba(0,0,0,0.3); }
.cal-nav {
...
.cal-weekday  { text-align: center; font-size: 1rem; font-weight: 600; color: rgba(255,255,255,0.85); padding: 8px 0; }
.cal-grid     { display: grid; grid-template-columns: repeat(7,1fr); gap: 2px; }
.cal-cell {
    min-height: 80px; padding: 8px 6px; border-radius: 10px;
...
.cal-day-num { font-size: 1rem; color: rgba(255,255,255,0.9); width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 500; }
.cal-badges  { display: flex; flex-wrap: wrap; gap: 4px; justify-content: center; }
.cal-badge   { width: 26px; height: 26px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.72rem; font-weight: 800; color: #fff; box-shadow: 0 2px 6px rgba(0,0,0,0.3); }
...
.cal-day-off__icon   { font-size: 1rem; }
.cal-day-off__reason { font-size: 0.6rem; color: rgba(255,255,255,0.7); text-align: center; line-height: 1.2; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; max-width: 100%; }
.cal-loading { display: flex; justify-content: center; padding: 48px 0; }
.cal-spinner { width: 40px; height: 40px; border: 3px solid rgba(255,255,255,0.2); border-top-color: #fff; border-radius: 50%; animation: spin 0.8s linear infinite; }
@keyframes spin { to { transform: rotate(360deg); } }
@media (max-width: 767px) {
    .cal-wrapper { padding: 16px 10px; }
    .cal-month   { font-size: 2rem; }
    .cal-cell    { min-height: 56px; padding: 4px 2px; }
    .cal-day-num { font-size: 0.82rem; width: 24px; height: 24px; }
    .cal-badge   { width: 20px; height: 20px; font-size: 0.62rem; }
    .cal-weekday { font-size: 0.75rem; }
}
</style>