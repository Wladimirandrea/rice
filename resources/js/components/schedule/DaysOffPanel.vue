...
.dop-field__icon i { color: #fff; font-size: 0.9rem; }
.dop-field__icon--blue { background: #1565c0; }
.dop-field__icon--red  { background: #e53935; }
...
.dop-input::-webkit-calendar-picker-indicator { filter: invert(1); cursor: pointer; }
...
.dop-reason__input::placeholder { color: rgba(255,255,255,0.4); }
...
.dop-save-btn:hover:not(:disabled) { filter: brightness(1.15); transform: translateY(-1px); }
.dop-save-btn:disabled { opacity: 0.6; cursor: not-allowed; }

/* List */
.dop-card--list { max-height: 320px; display: flex; flex-direction: column; }
...
.dop-item__delete:hover { background: rgba(229,57,53,0.4); }
...
@media (max-width: 1024px) {
    .dop-wrapper { width: 100%; min-width: unset; }
}
</style>